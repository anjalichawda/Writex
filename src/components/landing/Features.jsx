...
const Features = () => {
  return (
    <div id='features' className='relative py-24 lg:9y-32 bg-white overflow-hidden'>
      <div className='absolute inset-0 pointer-events-none bg-gradient-to-b from-violet-50/50 via-transparent to-purple-50/50'></div>
      <div className='max-w-7xl mx-auto px-6 lg:px-8 relative '>
        <div className='text-center mb-20 space-y-4'>
          ...
          <h2 className='text-4l sm:text-5xl lg:text-5xl font-bold text-gray-900  tracking-tight '>
              ...
              className='group relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300  hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-y-1 '>
                ...
                <div className='relative space-y-4 '>
                  ...
                  <div className='pt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                    <span className='text-violet-600 text-sm font-medium inline-flex items-center'>Learn more</span>
                    <svg 
