  ...
  return (
   <footer className='relative bg-linear-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden'>
    <div className='absolute inset-0 opacity-5'>
        <div className='absolute top right-0 w-96 h-96 bg-violet-500 rounded-full blur-3xl'></div>
    </div>
    <div className='relative max-w-7xl mx-auto px-6 lg:px-8'>
      <div className='py-16 grid grid-cols-1 md:grid-cols-12 gap-12'>
          <div className='md:col-span-5 space-y-6'>
            <a href="/" className='flex items-center space-x-2.5 group'>
                <div className='w-10 h-10 bg-linear-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/30 group-hover:shadow-violet-500/50 transition-allduration-300 group-hover:scale-105'>
        ...
        <div className='md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8'>
            <div >
                ...
                <ul className='space-y-3'>
                    ...
                    <li>
                        <a href="#templates" className='text-gray-400 hover:text-violet-400 transition-colors '>
                            Templates
                        </a>
                    </li>
                </ul>
    ...
    <div className='border-t border-white/10 py-8'>
        <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
            <p className='text-gray-400 text-sm'>{new Date().getFullYear()} eBook Creator. All rights reserved.</p>
